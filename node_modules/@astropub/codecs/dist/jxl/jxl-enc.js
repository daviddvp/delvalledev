...
function createWasm(wasmBinary) {
	var info = {
		"a": asmLibraryArg
	};
	...
	function instantiateArrayBuffer(receiver) {
		return Promise.resolve(wasmBinary).then(function (binary) {
	...
	return instantiateArrayBuffer(receiveInstantiationResult).catch(readyPromiseReject);;
	return {};
}
...
function __emval_get_global(name) {
	if (name === 0) {
		...
		return __emval_register(globalThis[name] || Module.globalThis[name]);
	}
}
...
var dynCall_iiiiij = Module.dynCall_iiiiij = function () {
	return (dynCall_iiiiij = Module.dynCall_iiiiij = Module.asm.O).apply(null, arguments);
};
var dynCall_iiiiijj = Module.dynCall_iiiiijj = function () {
	return (dynCall_iiiiijj = Module.dynCall_iiiiijj = Module.asm.P).apply(null, arguments);
};
var dynCall_iiiiiijj = Module.dynCall_iiiiiijj = function () {
	return (dynCall_iiiiiijj = Module.dynCall_iiiiiijj = Module.asm.Q).apply(null, arguments);
};
var calledRun;
...
function run(wasmBinary) {
		if (wasmBinary) createWasm(wasmBinary);
